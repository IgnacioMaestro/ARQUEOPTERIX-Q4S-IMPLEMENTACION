...
std::string makeQosLevelLine(int up, int down)
{
	...
	line.append(std::to_string((_ULonglong)up));
    line.append("/");
	line.append(std::to_string((_ULonglong)down));
    line.append("\n");
	return line;
}
...
std::string makeAppAlertPauseLine(unsigned long appAlertPause)
{
	...
	line.append(std::to_string((_ULonglong)appAlertPause));
    line.append("\n");
	return line;
}
...
std::string makeRecoveryPauseLine(unsigned long recoveryPause)
{
	...
	line.append(std::to_string((_ULonglong)recoveryPause));
    line.append("\n");
	return line;
}
...
std::string makeLatencyLine(unsigned long latency)
{
	...
	line.append(std::to_string((_ULonglong)latency));
    line.append("\n");
	return line;
}
...
std::string makeJitterLine(unsigned long jitterUp, unsigned long jitterDown)
{
	...
	line.append(std::to_string((_ULonglong)jitterUp));
    line.append("/");
	line.append(std::to_string((_ULonglong)jitterDown));
    line.append("\n");
	return line;
}
...
std::string makeBandWidthLine(unsigned long bandwidthUp, unsigned long bandwidthDown)
{
	...
	line.append(std::to_string((_ULonglong)bandwidthUp));
    line.append("/");
	line.append(std::to_string((_ULonglong)bandwidthDown));
    line.append("\n");
	return line;
}
...
std::string makePacketLossLine(float packetLossUp, float packetLossDown)
{
	...
	streamPacketLossDown << packetLossDown;
	line.append(streamPacketLossDown.str());
    line.append("\n");
	return line;
}
...
std::string makeProcedureLine(Q4SSDPProcedure procedure)
{
	...
	line.append(std::to_string((_ULonglong)procedure.negotiationTimeBetweenPingsUplink));
	line.append("/");
	line.append(std::to_string((_ULonglong)procedure.negotiationTimeBetweenPingsDownlink));
	line.append(",");
	line.append(std::to_string((_ULonglong)procedure.continuityTimeBetweenPingsUplink));
	line.append("/");
	line.append(std::to_string((_ULonglong)procedure.continuityTimeBetweenPingsDownlink));
	line.append(",");
	line.append(std::to_string((_ULonglong)procedure.bandwidthTime));
	line.append(",");
	line.append(std::to_string((_ULonglong)procedure.windowSizeLatencyCalcUplink));
	line.append("/");
	line.append(std::to_string((_ULonglong)procedure.windowSizeLatencyCalcDownlink));
	line.append(",");
	line.append(std::to_string((_ULonglong)procedure.windowSizePacketLossCalcUplink));
	line.append("/");
	line.append(std::to_string((_ULonglong)procedure.windowSizePacketLossCalcDownlink));
